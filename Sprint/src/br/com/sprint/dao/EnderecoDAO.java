...
public class EnderecoDAO {
	...
	public int deletePorCep(int cep) throws Exception{
	...
	public Endereco getEnderecoByCep(int cep) throws Exception{
	...
	public Endereco getEndereco(int cep) throws Exception{
		stmt = con.prepareStatement("SELECT * FROM ENDERECOS WHERE CEP = ?");
